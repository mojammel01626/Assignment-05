    ...
    return (
        <div>
            <div className='container mx-auto ]'>
                ...
                <p className='font-light text-xl text-gray-500 my-[20px]'>Pick one technology per category to build your ideal stack.</p>
            </div>
            
            <div className=' container mx-auto grid grid-cols-12'>
                <div className='bg-amber-500 col-span-9 '>
                    
                    <LeftSideBar fetchDataProductsPushinLeftSideBar={fetchDataProducts}/>
                </div>


                <div className=' bg-amber-950 col-span-3'>
                        <RightSideBar fetchDataProductsPushinRightSideBar ={fetchDataProducts} />
                </div>
            </div>
        </div>
    );
